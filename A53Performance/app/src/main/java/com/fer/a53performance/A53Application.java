...
public final class A53Application extends Application {
    @Override public void onCreate(){
        ...
        OneTimeWorkRequest maintenance=new OneTimeWorkRequest.Builder(AutoWorker.class).setInitialDelay(20,TimeUnit.SECONDS).setConstraints(constraints).build();
        WorkManager.getInstance(this).enqueueUniqueWork("a53-maintenance-warm",ExistingWorkPolicy.REPLACE,maintenance);
