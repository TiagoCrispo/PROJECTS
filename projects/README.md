...
This directory is the structured index for the software projects in this repository. Each project page answers the same questions first: **what it is, what problem it solves, which technologies/capabilities it demonstrates, its current status, and what has actually been validated**.

## Current projects

| Project | Area | Current status |
|---|---|---|
| **[ProAim](./proaim.md)** | Windows · performance · latency · diagnostics | Stable · v26.7 |
...
| Project | Area | Why it remains here |
|---|---|---|
| **[Global Food](./global-food.md)** | HTML · CSS | Early 2021 frontend work kept as a visible progression point |
...
Project documentation deliberately avoids claiming tests that were not run. Static analysis, emulator tests, package/signature validation, physical-device testing and real-world acceptance are described separately when they are different gates.

The repository-wide engineering rules are in **[`../AGENTS.md`](../AGENTS.md)**.
